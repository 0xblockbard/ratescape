    ...
    <div class="w-full pt-2 pb-16 h-full min-h-screen ">
        ...
        <div class="flex items-center max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <h1 class="flex items-center text-2xl flex-1 font-semibold text-gray-900">
                <span class="w-24 text-base sm:w-auto sm:text-xl">Edit Category:</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            {!! Form::model($category, ['route' => ['admin_categories_update', $category->type, $category->slug], 'method' => 'PUT', 'id' => 'category_form'])  !!}
                ...
                <div class="page_main_content lg:col-span-12 mt-3 sm:mt-2 space-y-6 sm:space-y-5">
                    ...
                    <div class="sm:grid sm:grid-cols-10 sm:gap-4 sm:items-start sm:pt-1">
                        <div class="page_main_field mt-1 sm:mt-0 sm:col-span-12">
                            <input type="text" value="{{ $category->name }}" placeholder="Category Name" name="name" id="name" autocomplete="name" class="block sm:text-lg font-semibold w-full shadow-sm focus:ring-neongreen-500 focus:border-neongreen-500 border-neongreen-300 rounded-md bg-cream-200">
                        </div>
                    </div>

                    <div class="sm:grid sm:grid-cols-10 sm:gap-4 sm:items-start sm:pt-1">
                        <div class="page_main_field mt-1 sm:mt-0 sm:col-span-12">
                            <textarea name="description" placeholder="Category Description" rows="2" style="resize:none" class="shadow-sm block w-full focus:ring-neongreen-500 focus:border-neongreen-500 sm:text-sm border-neongreen-300 rounded-md bg-cream-200">{!! $category->description  !!}</textarea>
                        </div>
                    </div>
