...
@section('content')
    ...
    <div class="container_section">
        ...
        <div class="form_container admin_form_container admin_form_small_container">
            ...
            {!! Form::model($user, ['route' => ['admin_users_update', $user->uuid], 'files' => 'true', 'method' => 'PUT'])  !!}

            <div class="field">
                <div class="control">
                    {!! Form::text('name', null, ['class' => 'input is-info', 'placeholder' => 'Name']) !!}
                </div>
            </div>

            <div class="field">
                <div class="control">
                    {!! Form::email('email', null, ['class' => 'input is-info', 'placeholder' => 'jonsmith@example.com']) !!}
                </div>
            </div>

            <div class="field">
                <div class="control">
                    <input name="password" class="input is-info" type="password" placeholder="••••••••••••" autocomplete="off" >
                </div>
            </div>
