    ...
    <div class="relative mx-auto max-w-7xl py-6 px-10 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div class="mx-auto text-base lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-8">
            ...
            <div class="lg:col-start-1 mt-32">
                <h2 class="text-2xl font-semibold text-graphite-500">Login</h2>

                <div class="mt-2">

                    <h3 class="mt-4 text-base text-graphite-500 font-semibold">
                        Enter your email, and we'll send you a magic link for quick access
                    </h3>

                    <form action="{{ route('process_magic_link') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <div class="mt-1">
                                <input id="email" name="email" placeholder="Your Email Address" type="email" autocomplete="email" value="{{ old('email') }}" required class="appearance-none block w-full px-3 py-2 shadow-sm focus:ring-neongreen-300 focus:border-neongreen-300 border-neongreen-300 rounded-md bg-cream-200 placeholder-gray-400 focus:outline-none sm:text-sm">    
                            </div>
                        </div>
