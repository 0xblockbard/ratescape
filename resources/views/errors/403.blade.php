        ...
        <main class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-xl py-16 sm:py-24">
                ...
                <div class="text-center">
                    <p class="text-6xl font-semibold text-blue-600">403</p>
                    <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Forbidden.</h1>
                    <p class="mt-2 text-lg text-gray-500">Oops, you don't have enough permission to access this page.</p>
                </div>
