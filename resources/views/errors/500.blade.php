        ...
        <main class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-xl py-16 sm:py-24">
                ...
                <div class="text-center">
                    <p class="text-6xl font-semibold text-blue-600">500</p>
                    <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Internal Server Error.</h1>
                    <p class="mt-2 text-lg text-gray-500">Oops, something seems to have gone wrong.</p>
                </div>
