<div id="delete" x-show="deleteModal" x-cloak
     class="delete_modal fixed z-20 inset-0 overflow-y-auto overlay">
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
        ...
        <div x-description="Modal panel, show/hide based on modal state."
             x-on:click.away="deleteModal = false;"
             x-transition:enter="ease-out duration-300"
            ...
            <div class="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                <button x-on:click="deleteModal = false" type="button" class="bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
