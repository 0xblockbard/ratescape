    ...
    */
    ...
    'settings' => [
        ...
        */
        ...
        'HTML.Allowed' => 'h1[style],h2[style],h3[style],h4[style],h5[style],h6[style],b,strong,i,em,a[href|title|rel|target|class],ul,ol,li,p[style],br,span[style],div[style],img[style|width|height|alt|src|data-src|class],blockquote[class],iframe[width|height|src|frameborder]',

        // Safe Iframe
        'HTML.SafeIframe'  => true,
        'URI.SafeIframeRegexp' => '%^(http://|https://|//)(www.youtube.com/embed/|player.vimeo.com/video/|www.instagram.com/p/)%',
